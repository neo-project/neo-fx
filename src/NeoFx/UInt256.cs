...
namespace NeoFx
{
    ...
    {
        public readonly struct Factory : IFactoryReader<UInt256>
        {
            public bool TryReadItem(ref BufferReader<byte> reader, out UInt256 value) => TryRead(ref reader, out value);
        }
