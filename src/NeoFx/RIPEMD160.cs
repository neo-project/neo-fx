...
namespace NeoFx
{
    // Note, this implemetnation of RIPEMD160 was copied as is (modulo namespace change) from NEO project

    // TODO: Replace this implementation of RIPEMD160 w/ one better tuned for .NET Standard 2.1 
    //       (i.e. one that uses spans instead of arrays)
    internal class RIPEMD160Managed : HashAlgorithm
    {
