...
namespace StorageExperimentation
{
    static class SequenceReaderExtensions
    {
        ...
        public static bool TryReadUInt256(ref this SequenceReader<byte> reader, out UInt256 value) =>
            reader.TryRead(UInt256.Size, UInt256.TryReadBytes, out value);

        public static bool TryReadUInt160(ref this SequenceReader<byte> reader, out UInt160 value) =>
            reader.TryRead(UInt160.Size, UInt160.TryReadBytes, out value);
    }
}
